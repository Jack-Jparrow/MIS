 ...
 * @Last Modified time: 2021-06-16 08:42:30
 */

public class OrdinaryMembers extends JFrame implements ActionListener {

    public JLabel yourId, yourName, yourSex, yourActivityLastWeek, yourTotalPointsAsOfLastWeek,
            yourTotalPointsOfLastWeek, yourIncreaseOfIntegral, yourGPA, yourRange, yourPost, modifyKey;
    ...
    void ordinaryMembers() {
        ...
        sl.putConstraint(SpringLayout.HORIZONTAL_CENTER, yourActivityLastWeek, -130, SpringLayout.HORIZONTAL_CENTER,
                cot);
        ...
        sl.putConstraint(SpringLayout.HORIZONTAL_CENTER, yourIncreaseOfIntegral, -130, SpringLayout.HORIZONTAL_CENTER,
                cot);
        ...
        sexInf = new JTextField(10);
        sexInf.setEditable(false);
        ...
        sl.putConstraint(SpringLayout.HORIZONTAL_CENTER, sexInf, 11, SpringLayout.HORIZONTAL_CENTER, cot);
        ...
        activityLastWeekInf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(244, 64, 54)));
        sl.putConstraint(SpringLayout.HORIZONTAL_CENTER, activityLastWeekInf, 50, SpringLayout.HORIZONTAL_CENTER, cot);
        ...
        sl.putConstraint(SpringLayout.HORIZONTAL_CENTER, totalPointsAsOfLastWeekInf, 50, SpringLayout.HORIZONTAL_CENTER,
                cot);
        ...
        totalPointsOfLastWeekInf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(244, 64, 54)));
        sl.putConstraint(SpringLayout.HORIZONTAL_CENTER, totalPointsOfLastWeekInf, 50, SpringLayout.HORIZONTAL_CENTER,
                cot);
        ...
        increaseOfIntegralInf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(244, 64, 54)));
        sl.putConstraint(SpringLayout.HORIZONTAL_CENTER, increaseOfIntegralInf, 50, SpringLayout.HORIZONTAL_CENTER,
                cot);
        ...
        xgxb = new JButton("修改");
        xgxb.addActionListener(this);
        sl.putConstraint(SpringLayout.HORIZONTAL_CENTER, xgxb, 115, SpringLayout.HORIZONTAL_CENTER, cot);
        sl.putConstraint(SpringLayout.NORTH, xgxb, 210, SpringLayout.NORTH, cot);
        cot.add(xgxb);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (e.getSource() == xgxb) {

            ModifySex ms = new ModifySex();
            ms.modifySex();
            // this.setEnabled(false);
        }else if(e.getSource() == jbgm){
    ...
    void searchSqlDatebase(String addr, String strid) {
        ...
        try {
            ...
            // String dlstr1 = "select * from weekContains" + convertWeekByDate(swapstd()) +
            // " where Id = '" + strid + "'";
            ...
            while (rss.next()) {
                idInf.setText(rss.getString("Id"));
                nameInf.setText(rss.getString("Pname"));
                sexInf.setText(rss.getString("Sex"));
                activityLastWeekInf.setText(rss.getString("ActivityLastWeek"));
                totalPointsAsOfLastWeekInf.setText(rss.getString("TotalPointsAsOfLastWeek"));
                totalPointsOfLastWeekInf.setText(rss.getString("TotalPointsOfLastWeek"));
                increaseOfIntegralInf.setText(rss.getString("IncreaseOfIntegral"));
                rangeInf.setText(rss.getString("Prange"));
                GPAInf.setText(rss.getString("GPA"));
                postInf.setText(rss.getString("Post"));
            }
